...
num_classes = 751  # Change this depending on your dataset
...
class MGN(nn.Module):
    def __init__(self):
        ...
        self.gradients = {'p1': None, 'p2': None, 'p3': None}
    ...
    def forward(self, x):
        ...
        p1.register_hook(self.save_gradient('p1'))
        p2.register_hook(self.save_gradient('p2'))
        p3.register_hook(self.save_gradient('p3'))
        ...
        return predict, fg_p1, fg_p2, fg_p3, l_p1, l_p2, l_p3, l0_p2, l1_p2, l0_p3, l1_p3, l2_p3, zg_p1, zp2, zp3, p1, p2, p3
